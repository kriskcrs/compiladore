...
//variables, metodos y funciones que necesite (codigo java)
  ...
  private void error(String message) {
        ...
        /*autor Cristian
        Aqui se instancia la clase ErrorLexico, para poder guardar los valores recuperados del message que recibe el metodo
        */
        ErrorLexico mensaje = new ErrorLexico();
        mensaje.setTipo("Lexico");
        mensaje.setLinea(yyline+1);
        mensaje.setColumna(yycolumn+1);
        mensaje.setCaracter(message);
        
        //se agrega al array declarado en ArbolAst
        ArbolAst.errorL.add(mensaje);
